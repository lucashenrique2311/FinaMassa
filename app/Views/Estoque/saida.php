  ...
  <div class="container-fixed flex items-center justify-between flex-wrap gap-3">
    <div class="flex items-center flex-wrap gap-1 lg:gap-5">
      ...
      <div class="flex items-center gap-1 text-sm font-normal">
        ...
        <span class="text-gray-400 text-sm">/</span>
        <span class="text-gray-900">Saída</span>
      </div>
    </div>
...
<div class="container-fixed" style="max-width: 1600px !important;">
  <div class="grid gap-5 lg:gap-7.5">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="<?= base_url('Estoque/registrarSaida') ?>" method="post" id="form_saida">
          <?= csrf_field() ?>
...
document.getElementById('form_saida')?.addEventListener('submit', function(e) {
